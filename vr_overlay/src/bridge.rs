    ...
    pub async fn connect(
        ...
        loop {
            match client.next_message().await? {
                ...
                OverlayBridgeEvent::AuthError(reason) => {
        ...
        match message {
            Message::Text(text) => {
                ...
                let Value::Object(map) = payload else {
                    return Err(BridgeError::Protocol("payload must be a JSON object".into()));
                };
                ...
                match map.get("type").and_then(Value::as_str) {
                    ...
                    Some("snapshot") => {
                        ...
                        let snapshot: OverlayPresentationSnapshot = serde_json::from_value(snapshot_val)
                            .map_err(|error| BridgeError::Protocol(error.to_string()))?;
